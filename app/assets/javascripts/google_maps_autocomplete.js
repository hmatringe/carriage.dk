...
function onPlaceChanged() {
  ...
  $('#bike_address').trigger('blur').val(components.address);
  $('#bike_zip_code').val(components.zip_code);
  $('#bike_city').val(components.city);
  if (components.country_code) {
    $('#bike_country').val(components.country_code);
  }
}
